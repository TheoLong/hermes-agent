...
def test_default_spawn_passes_task_skills_verbatim(kanban_home, monkeypatch):
    ...
    # The fixture HERMES_HOME has none of these skills installed; opt out of
    # the dispatch-time resolvability gate so they pass through unfiltered
    # (the gate has its own dedicated tests below).
    monkeypatch.setenv("HERMES_KANBAN_SKIP_SKILL_PREFLIGHT", "1")
    captured = {}
